...
namespace SWP391_SE1914_ManageHospital.Service
{
    public interface IMedicineImportDetailService
    {
        ...
        public Task<MedicineImportDetailPageDTO> SearchMedicineImportDetailAsync(string keyword, DateTime? startDate, DateTime? endDate, int pageNumber, int pageSize = 10);
