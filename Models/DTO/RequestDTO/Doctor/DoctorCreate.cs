...
public class DoctorCreate
{
    ...
    public DoctorCreate() { }
    public DoctorCreate(int id, string name, string code, Gender gender, DateTime dob, string cCCD, string phone, string? imageURL, string licenseNumber, float yearOfExperience, float workingHours, DoctorStatus status, int userId, int departmentId, DateTime createDate, DateTime? updateDate, string createBy, string? updateBy)
    {
        Id = id; Name = name;
        Code = code;
        Gender = gender;
