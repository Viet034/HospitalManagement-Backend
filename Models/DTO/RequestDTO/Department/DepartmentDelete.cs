...
public class DepartmentDelete
{
    ...
    public DepartmentDelete(int id, string name, string code, string description, int totalAmountOfPeople, DepartmentStatus status, DateTime createDate, DateTime? updateDate, string createBy, string? updateBy)
    {
        Id = id;
        Name = name;
        Code = code;
