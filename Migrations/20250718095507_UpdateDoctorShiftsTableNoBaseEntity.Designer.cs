...
namespace SWP391_SE1914_ManageHospital.Migrations
{
    ...
    [Migration("20250718095507_UpdateDoctorShiftsTableNoBaseEntity")]
    partial class UpdateDoctorShiftsTableNoBaseEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SWP391_SE1914_ManageHospital.Models.Entities.Shift_Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SWP391_SE1914_ManageHospital.Models.Entities.Shift_Request", b =>
                {
                    ...
                    b.HasOne("SWP391_SE1914_ManageHospital.Models.Entities.Doctor_Shift", "Doctor_Shift")
                        .WithMany()
                        .HasForeignKey("Doctor_ShiftId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Doctor");

                    b.Navigation("Doctor_Shift");
                });
